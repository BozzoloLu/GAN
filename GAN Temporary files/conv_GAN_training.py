...
gen_net = ConvGenerator(z_dim = z_dim).to(device)
disc_net = ConvDiscriminator(image_size*image_size).to(device)
...
for run in range(runs): 
    ...
    gan = GAN(model = 'Classical_convolutional', dataloader = dataloader, gen_net = gen_net, disc_net = disc_net, z_dim = z_dim, image_size = image_size, 
